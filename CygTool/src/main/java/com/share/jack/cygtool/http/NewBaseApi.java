...
import com.share.jack.cygtool.http.convert.CustomGsonConverterFactory;
import com.share.jack.cygtool.http.instance.GetInstance;
...
//        builder.addInterceptor(new MarvelSigningInterceptor("TAG"));
    ...
    public static <T> T getPresent(Class<T> cls) {
        T instance = GetInstance.getInstance(cls);
        if (instance == null) {
            return null;
        }
        return instance;
