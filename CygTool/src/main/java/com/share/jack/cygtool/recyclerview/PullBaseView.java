package com.share.jack.cygtool.recyclerview;
...
import com.share.jack.cygtool.R;
...
public abstract class PullBaseView<T extends RecyclerView> extends LinearLayout {
    ...
    private OnRefreshHeaderListener refreshHeaderListener;
    private OnRefreshFooterListener refreshFooterListener;
    ...
    public void headerRefreshing() {
        ...
        if (refreshHeaderListener != null) {
            refreshHeaderListener.onHeaderRefresh(this);
        }
    }
    ...
    private void footerRefreshing() {
        ...
        if (refreshFooterListener != null) {
            refreshFooterListener.onFooterRefresh(this);
        }
    }
     ...
     * @description
     */
    public void setOnRefreshHeaderListener(OnRefreshHeaderListener refreshHeaderListener) {
     ...
     * @description
     */
    public void setOnRefreshFooterListener(OnRefreshFooterListener refreshFooterListener) {
        this.refreshFooterListener = refreshFooterListener;
    }
